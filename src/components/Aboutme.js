  ...
  return (
    <Container className="mt-5" id="aboutme">
      ...
      <p className="text-center text mt-3 mb-5">
        Soy Ingeniera en Sistemas, apenas obtuve mi título comencé a desarrollar
        sitios web programando en PHP. Por cuestiones personales decidí
        dedicarme a otra cosa por mucho tiempo y dejé la programación.
      </p>
      <p className="text-center text mt-3 mb-5">
        ...
        aprendí metodologías ágiles SCRUM y desarrollé 3 proyectos aplicando las
        tecnologías aprendidas. Mi propósito es seguir actualizándome y
